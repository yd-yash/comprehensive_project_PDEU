% =========================================================================
% plots_thesis_smc.m — Thesis-Quality Simulation Plots (SMC Controller)
% =========================================================================
...
%   Fig 7 : Sliding Variables   (s_phi, s_theta, s_psi vs time)
%
% INPUTS:
%   t    - time vector (Nx1)
%   x    - state matrix (Nx12)
...
%
% SAVED FILES:
%   SMC_Fig1_3D_Trajectory.png
%   SMC_Fig2_Position_Tracking.png
%   SMC_Fig3_Attitude_Tracking.png
%   SMC_Fig4_Position_Errors.png
%   SMC_Fig5_Attitude_Errors.png
%   SMC_Fig6_Control_Inputs.png
%   SMC_Fig7_Sliding_Variables.png
% =========================================================================
...
function plots_thesis(t, x, logs, p)
    ...
    % Uses logs.U1_cmd_log ... U4_cmd_log from reconstruct_signals.m
    % ======================================================================
    ...
    % ======================================================================
    % FIGURE 7 — Sliding Variables (s_phi, s_theta, s_psi)
    % Attitude sliding surfaces only — these are the three primary surfaces
    % used in U2, U3, U4 respectively.  s_x, s_y, s_z are inner-loop
    % virtual-input surfaces and are included as a second row for completeness.
    % ======================================================================
    ...
    fprintf('\n[plots_thesis_smc] All figures saved to: %s\n', save_dir);
