...
% Trajectory - Yaw While Translating
% Control - PID
...
params.x_des = @(t) 2*sin(0.3*t);
params.y_des = @(t) 0;
params.z_des = @(t) 2;


params.x_dot_des = @(t) 0.6*cos(0.3*t);
params.y_dot_des = @(t) 0;
params.z_dot_des = @(t) 0;

params.x_ddot_des = @(t) -0.18*sin(0.3*t);
params.y_ddot_des = @(t) 0;
params.z_ddot_des = @(t) 0;

params.psi_des = @(t) pi/3*sin(0.3*t);
params.psi_ref = @(t) 0;
