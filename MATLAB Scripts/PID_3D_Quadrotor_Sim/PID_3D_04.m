...
params.x_des = @(t) 2*cos(0.6*t);
params.y_des = @(t) 2*sin(0.6*t);
params.z_des = @(t) 0.5 + 0.25*t;

params.x_dot_des = @(t) -1.2*sin(0.6*t);
params.y_dot_des = @(t) 1.2*cos(0.6*t);
params.z_dot_des = @(t) 0.25;

params.x_ddot_des = @(t) -0.72*cos(0.6*t);
params.y_ddot_des = @(t) -0.72*sin(0.6*t);
