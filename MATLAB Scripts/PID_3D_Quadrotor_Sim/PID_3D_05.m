...
% Trajectory - figure 8 (direction reversal)
% Control - PID
...
params.x_des = @(t) 2*sin(0.4*t);
params.y_des = @(t) 2*sin(0.8*t);
params.z_des = @(t) 2;

params.x_dot_des = @(t) 0.8*cos(0.4*t);
params.y_dot_des = @(t) 1.6*cos(0.8*t);
params.z_dot_des = @(t) 0;

params.x_ddot_des = @(t) -0.32*sin(0.4*t);
params.y_ddot_des = @(t) -1.28*sin(0.8*t);
